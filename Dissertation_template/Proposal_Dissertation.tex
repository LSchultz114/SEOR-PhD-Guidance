...
\newcommand{\mininline}[3]{$$\mbox{minimize}_{#1}\quad#2\qquad\mbox{subject to }#3$$}
\DeclareMathOperator*{\mini}{minimize}
\DeclareMathOperator*{\argmax}{arg\,max}
\DeclareMathOperator*{\argmin}{arg\,min}

\usepackage{graphicx,float}%, float,wrapfig}
...
\title{Dissertation\\
            Title}
\onelinetitle{Dissertation Title}
\author{John Smith}
\degree{Doctor of Philosophy}
\doctype{Dissertation}
\dept{Systems Engineering and Operations Research}
\discipline{Operations Research}

\seconddeg{Master of xyz}
\seconddegschool{school name}
\seconddegyear{grad year}

\firstdeg{Bachelor of xyz}
\firstdegschool{school name}
\firstdegyear{grad year}

\degreeyear{planned phd grad year}
...
\firstmember{Committee member 1}

\secondmember{Committee member 2}

\thirdmember{Committee member 3}
